...
class speechRecongnizerTask:
    def __init__(self):
        ...
        self.hotwords = ["ouvrir la lumière de l'entrée", "allumer la lumière de l'entrée",
                    ...
                    "éteindre la lumière de l'entrée", "ouvrir la lumière du salon",
                    "allumer la lumière du salon",
                    "fermer la lumière du salon", "éteindre la lumière du salon", "quelle heure est-il",
                    "il est quelle heure", "quel temps fait-il", "ouvrir la porte de l'entrée",
                    "fermer la porte de l'entrée", "ouvrir l'alarme", "activer l'alarme", "fermer l'alarme", "désactiver l'alarme"]
...
def speech_onclick():
    ...
    if handle['speech']:
        ...
        titlelabel = Label(speechframe, text='command', font="Helvetica 18 bold")
...
speechFrame = LabelFrame(leftFrame, text='Speech', font="Helvetica 20 bold", padx=10, pady=10)
speechFrame.grid(row=4, column=0)
speechBtn = Button(speechFrame, text='Afficher', font="Helvetica 18 bold", command=speech_onclick)
